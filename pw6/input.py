...
class University:
    ...
    def set_students(self, stdscr):
        ...
        with open("student.pickle", "ab") as student_file:
            for _ in range (num_students):
                ...
                pickle.dump(self.__students, student_file)
    ...
    def set_courses(self, stdscr):
        ...
        with open("course.pickle", "ab") as course_file:
            for _ in range (num_courses):
                ...
                pickle.dump(self.__courses, course_file) 
    ...
    def set_scores(self, stdscr):
        ...
        if course is None:
            ...
            stdscr.getch()
            return 
        with open("score.pickle", "ab") as score_file:
            for student in self.__students:
                ...
                pickle.dump(self.__scores, score_file)
    ...
    def compress_file(self):
        try:
            ...
            with open("score.pickle", "rb") as score_file:
    ...
    def decompress_file(self):
        if os.path.exists("students.dat"):
            try:
                ...
                num_scores = len(self.__scores)
                total_objects = num_students + num_courses + num_scores
                chunk_size = len(decompressed_data) // total_objects

                student_data = decompressed_data[:chunk_size * num_students]
                course_data = decompressed_data[chunk_size * num_students: chunk_size * (num_students + num_courses)]
                score_data = decompressed_data[chunk_size * (num_students + num_courses):]

                self.__students = pickle.loads(student_data)
                self.__courses = pickle.loads(course_data)
                self.__scores = pickle.loads(score_data)
